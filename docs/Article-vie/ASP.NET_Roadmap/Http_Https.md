...
sidebar_position: 3
id: http_https
title: Http/Https - Giao thức đặc biệt quan tâm đối với lập trình viên

---

# HTTP/ HTTPs

Ngoài Git-Version Control thì HTTP và HTTPs là 2 loại kiến thức đặc biệt quan trọng đối với lập trình. Trong phần này, ta sẽ cùng tìm hiểu về HTTP, HTTPs và các khái niệm liên quan đến chúng.
